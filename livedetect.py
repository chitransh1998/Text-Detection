...
while(True):
 ...
 class TextDetection(object):
    ...
    def detect(self):
        ...
        #bar = progressbar.ProgressBar(maxval=n1 or None, widgets=[progressbar.Bar(marker='=', left='[', right=']'), ' ', progressbar.SimpleProgress()])
        ...
        if contours != 'None' and hierarchies[0] != 'None':
 ...
 #plt.imsave("detecttexts.jpg",td.final)
 #plt.yticks([])
